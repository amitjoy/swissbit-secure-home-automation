 ...
 *******************************************************************************/
package com.swissbit.mqtt.client;
...
import com.swissbit.mqtt.client.operator.KuraPayloadDecoder;
import com.swissbit.mqtt.client.operator.KuraPayloadEncoder;

/**
 * Implementation of {@link KuraMQTTClient}
 * 
...
public class KuraMQTTClientImpl implements KuraMQTTClient {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(KuraMQTTClientImpl.class);
